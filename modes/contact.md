...
3. **Select primary target**: the person who would benefit most from having the candidate there

4. **Generate message** using the 3-sentence framework adapted to contact type:

   ### Recruiter
   - **Sentence 1 (Fit)**: Direct match criteria -- role, relevant experience, availability or location
   - **Sentence 2 (Proof)**: Data that answers their screening questions before they ask (e.g., "5 years building ML pipelines, currently in Berlin, available immediately")
   ...
   - **Sentence 2 (Proof)**: Candidate's biggest quantifiable achievement that shows they've solved similar problems
   ...
   - **Sentence 2 (Context)**: Light connection with the candidate's experience in that topic
