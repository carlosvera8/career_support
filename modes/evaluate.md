...
Classify the offer into one of 6 archetypes (see `_shared.md`). If hybrid, note the 2 closest. This determines:
...
If found, use `glassdoor_ds_it_wlb_score` as the Data Science/IT WLB score.
Note the value in the report: "WLB (Glassdoor DS/IT): X.X/5 — source: companies_merged.csv"

If the company is NOT in the CSV, continue to Step 2.

**Step 2 — Comp & demand via WebSearch:**
- Current salaries for the role (Levels.fyi, Blind, Glassdoor)
